...
10.  **Copy and paste the [provided code](https://github.com/voicehacks/setup-local-recommendations/blob/master/src/index.js) into the Lambda function code box.**  We have provided the code for this skill on [GitHub](../lambda/custom/index.js).  Delete the contents of the code box, and paste the contents of the new code.
